<?php
	...
	if(
		...
		if($obj->create()) {
			...
			// tell the user
			echo json_encode(array("message" => "Ordine insert successfully."));
		} else {
			// set response code - 503 service unavailable
			http_response_code(503);

			// tell the user
			echo json_encode(array("message" => "Unable to insert ordine."));
		}
		...
		// tell the user
		echo json_encode(array("message" => "Unable to insert ordine. Data is incomplete."));
	}
?>