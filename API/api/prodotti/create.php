<?php
	...
	if(
		...
		if($obj->create()) {
			...
			// tell the user
			echo json_encode(array("message" => "Prodotto insert successfully."));
		} else {
			// set response code - 503 service unavailable
			http_response_code(503);

			// tell the user
			echo json_encode(array("message" => "Unable to insert prodotto."));
		}
		...
		// tell the user
		echo json_encode(array("message" => "Unable to insert prodotto. Data is incomplete."));
	}
?>